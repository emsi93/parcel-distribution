            ...
            <div class="panel-body">
                <form:form method="post" modelAttribute="courierForm" action="/parcel/distribution/admin/addcourier" role="form">
                    ...
                    <div id="step2" style="display: none;">
                        <div class="form-group">
                            <label for="name"><spring:message code='addcourier.name'/></label>
                        ...
                        <div class="form-group">
                            <label for="surname"><spring:message code='addcourier.surname'/></label>
                        ...
                        <div class="form-group">
                            <label for="phoneNumber"><spring:message code='addcourier.phoneNumber'/></label>
