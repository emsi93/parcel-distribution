    ...
    <div class="col-lg-4">
        <div class="panel panel-warning box">
            ...
            <div class="panel-body">
                <form:form method="post" modelAttribute="parcelForm" action="/parcel/distribution/parcel/newparcel" role="form">
                    <div id="step1">
                        ...
                        <button class="submit btn btn-success" type="button" id="next1"><spring:message code='next'/></button>
                    </div>
                    ...
                    <div id="step2" style="display: none;">
                        ...
                        <button class="submit btn btn-success" type="button" id="return2"><spring:message code='return'/></button>
                        <button class="submit btn btn-success" type="button" id="next2"><spring:message code='next'/></button>
                    </div>
                    ...
                    <div id="step3" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            <form:input id="description" name="description" type="text" path="description" class="form-control" />
                            <div class="errors">
                                <span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span>
                        ...
                        <button class="submit btn btn-success" type="button" id="return3"><spring:message code='return'/></button>
